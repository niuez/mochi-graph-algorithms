...
#[cfg(test)]
mod dijkstra_with_potential_test {
    use graph::directed_graph::*;
    use graph::property::*;
    use graph::all_pairs_shortest_path::dijkstra_with_potential::*;
    #[test]
    fn dijkstra_with_potential_test() {
        {
            ...
            g.add_edge((2, 3, 1));
            g.add_edge((3, 2, 7));
            let dist = dijkstra_with_potential(&g, |e| ArbW::Some(e.2 as isize)).unwrap();
